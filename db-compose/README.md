...
This project uses Docker Compose to set up multiple services within a single environment. Currently, it includes PostgreSQL as the database and pgAdmin for database management, but the setup is designed to support additional services as needed.
...
- **Docker**: Ensure Docker is installed on your system. [Get Docker here](https://www.docker.com/products/docker-desktop).
- **Docker Compose**: Typically included with Docker Desktop, or check using:
